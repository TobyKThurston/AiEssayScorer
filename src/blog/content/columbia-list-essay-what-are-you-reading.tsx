...
export default function Content() {
  return (
    <>
      ...
      <h2>Why Columbia Asks This Question</h2>
      <p>
      ...
      <p>
        The question also gives Columbia information that standardized tests and grades cannot. A student with a 4.0 GPA who lists <em>The Da Vinci Code</em>, one Sparknotes summary, and a list of Instagram influencers in their books category is telling admissions officers something different from a student who lists <em>Debt: The First 5,000 Years</em>, <em>Every Good Boy Does Fine</em>, a Substack about quantum foundations, and a podcast on Ottoman history. Both might have identical transcripts.
      </p>
      <p>
        The list is a window into who you actually are when no one is assigning you anything.
      </p>

      <h2>What to Include in Each Category</h2>
      <p>
      ...
      <p>
        List the actual required reading from your current or most recent courses. Don't filter for prestige, Columbia wants honesty here, not performance. If your AP Chemistry class assigned <em>The Disappearing Spoon</em>, list it. If your English class read <em>Their Eyes Were Watching God</em>, list it.
      </p>
      <p>
      ...
      <ul>
        <li>Books that are thematically connected to each other in a way that suggests a genuine intellectual obsession</li>
        <li>At least one book that most high schoolers wouldn't encounter and wouldn't think to name</li>
        <li>Books that span disciplines (a novel, a work of history, a piece of philosophy, a science book) in a way that mirrors what the Core Curriculum itself does</li>
        <li>At least one book that connects to your intended area of study</li>
      </ul>
      <p>
      ...
      <h2>Films</h2>
      <p>
        Same principle. List films you've actually watched and found interesting, not a curated collection of Criterion classics. If you watched <em>Parasite</em> three times and found it genuinely compelling, list it. If you've been watching Akira Kurosawa films for the past year because you're interested in how he handles violence and morality, name the specific films.
      </p>
      <p>
        The films category is often where applicants over-curate. They list the most acclaimed films they've heard of rather than what they've actually watched. Admissions officers notice this. A list that includes three Ingmar Bergman films with no other explanation raises questions. A list that includes <em>I, Daniel Blake</em>, <em>Tangerine</em>, and <em>Moonlight</em> alongside a Netflix documentary about algorithms reads as authentic.
      </p>

      <h2>Websites, Podcasts, and Other Media</h2>
      <p>
      ...
      <p>
        Name specific publications, newsletters, or podcasts rather than categories. "Science podcasts" is useless. "Corey S. Powell's <em>Big Picture Science</em>, Sean Carroll's <em>Mindscape</em>, and the Simons Foundation's <em>Quanta Magazine</em>" is specific and tells an admissions officer something real.
      </p>
      <p>
      ...
      <h2>The Most Common List Question Mistakes</h2>
      <ul>
        <li><strong>Curating for impressiveness rather than accuracy.</strong> Admissions officers read thousands of lists. They recognize curation immediately. A list that reads like it was assembled from "books every intelligent person should have read" is obvious and counterproductive.</li>
        <li><strong>Listing too many items.</strong> "A few items per category" means three to five per category. A list with 40 entries reads as padding.</li>
        <li><strong>Including nothing unexpected.</strong> If your list looks identical to every other competitive applicant's list, it has failed its purpose. Include at least one thing in each category that is genuinely specific to your particular intellectual life.</li>
        <li><strong>No connective tissue across categories.</strong> The strongest lists have a coherence: reading, films, music, and websites that share at least some thematic thread. This coherence doesn't need to be explained, but it should be visible. It signals genuine intellectual identity rather than a randomly assembled set of culturally acceptable choices.</li>
        <li><strong>Mixing the list with the essay.</strong> The list should be a list. Don't add parenthetical justifications or brief reviews to each entry. That's what the essays are for.</li>
      </ul>

      <h2>How the List Connects to the Rest of Your Columbia Application</h2>
      <p>
