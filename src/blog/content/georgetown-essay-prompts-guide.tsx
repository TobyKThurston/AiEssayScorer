...
export default function Content() {
  return (
    <>
      <h2>Why Georgetown's Supplement Is Unusual</h2>
      <p>
      ...
      <h2>What Georgetown Admissions Is Screening For Across All Three Essays</h2>
      <p>
      ...
      <ul>
        <li><strong>Intellectual seriousness.</strong> Georgetown prides itself on being more tradition-minded than its peer institutions. This is not a place that rewards ironic distance or performance-based writing. It wants students who take ideas seriously enough to sit with them.</li>
        <li><strong>A commitment to service or social engagement.</strong> Not in the resume-building sense. Georgetown's Jesuit identity means the committee is reading for evidence that you think about obligations to people outside yourself.</li>
        <li><strong>Alignment with Jesuit values, even for non-Catholic applicants.</strong> You do not need to be Catholic, and most admitted students are not. But the essays should reflect some compatibility with reflection, formation, and concern for others - values that predate the institution's American existence.</li>
        <li><strong>A capacity for moral reasoning.</strong> Georgetown wants to see that you can think about why something matters, not just that it happened. This is the single most underweighted quality in most applicants' drafts.</li>
        <li><strong>Writing that demonstrates careful thought rather than cleverness.</strong> A polished metaphor that does not earn its place will hurt you here. Georgetown is suspicious of rhetorical flourishes that come at the expense of actual thinking.</li>
      </ul>

      <h2>Essay 1: Why Georgetown</h2>
      <p>
      ...
      <h2>Essay 2: School-Specific Essay</h2>
      <p>
      ...
      <ul>
        <li><strong>College of Arts and Sciences.</strong> The College typically asks some version of the "half-letter" prompt - why a future Georgetown education matters to you, usually framed through a specific academic interest. The answer should be grounded in a field, a question, or a line of inquiry that you have already started pursuing. Generic claims about liberal arts breadth will not land.</li>
        <li><strong>School of Foreign Service (SFS).</strong> This is the most distinctive prompt in the Georgetown supplement. SFS typically asks about a current global challenge or international issue that concerns you. The essay is SFS's filter, and the filter is real. It demands genuine specificity - a region, an institution, a policy debate - and evidence of sustained interest rather than opinion formed last week. Applicants who write this essay without any international engagement history stand out, in the wrong direction.</li>
        <li><strong>McDonough School of Business.</strong> McDonough's prompt consistently pushes at the intersection of business and ethics or business and social impact. Georgetown does not want Wharton-style pure finance applicants, and its prompt reflects that. Show that you can think about business in terms that are not purely transactional.</li>
        <li><strong>School of Nursing and Health Studies.</strong> The health equity angle is unavoidable here. The strongest applicants connect a personal experience with healthcare to a structural observation about access, outcomes, or disparities - the Jesuit tradition inside a clinical frame.</li>
        <li><strong>McCourt School.</strong> McCourt is primarily a graduate school, but where relevant, its prompts focus on public policy. Evidence of engagement with a specific policy area, ideally with some local or community grounding, is essential.</li>
      </ul>

      <h2>Essay 3: Meaningful Experience</h2>
      <p>
      ...
      <h2>What Strong Georgetown Essays Do</h2>
      <p>
      ...
      <h2>Georgetown-Specific Structural Advice</h2>
      <p>
      ...
      <ul>
        <li><strong>Treating the brief essay as a "why this school" fill-in-the-blank.</strong> You have 500 words. A bullet list of Georgetown features will not use them well.</li>
        <li><strong>Writing the SFS essay without specific geographic or institutional knowledge.</strong> Vague concern about "global issues" does not pass the SFS filter.</li>
        <li><strong>Using the same story across two of the three essays.</strong> The essays should portray different aspects of you. Reusing a central experience wastes a slot.</li>
        <li><strong>Mentioning Georgetown's Catholic identity without engaging with its values.</strong> Name-checking Jesuit tradition without demonstrating any alignment reads as pandering and does not help.</li>
        <li><strong>Treating the meaningful experience as just a moment.</strong> The prompt is not "describe a moment." It is asking how an experience has shaped you. Without the reflective arc, the essay is incomplete.</li>
        <li><strong>Ignoring the school-specific prompt's framing.</strong> Each school asks its question for a reason. Answering a different question, or a generic version of the same question, signals that you are not paying attention.</li>
        <li><strong>Applying to SFS without evidence of international engagement.</strong> SFS is the single most competitive program at Georgetown, and its readers are acutely aware of applicants using it as a prestige play. If your international engagement is thin, apply to the College instead.</li>
        <li><strong>Being too clever.</strong> Georgetown readers are unusually resistant to stylistic performance that substitutes for substance. Clarity beats cleverness here.</li>
      </ul>

      <h2>The Three-Essay Coordination Problem</h2>
      <p>
      ...
      <h2>How Georgetown Differs From Peer Schools' Supplements</h2>
      <p>
