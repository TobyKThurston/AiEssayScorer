...
export default function Content() {
  return (
    <>
      <h2>The Dartmouth "Let Your Life Speak" Prompt, Verbatim</h2>
      <p>
        Dartmouth's supplement asks applicants to choose one of several longer prompts and respond in about 250 words. One of the options reads: <em>"There is a Quaker saying: 'Let your life speak.' Describe the environment in which you were raised and the impact it has had on the person you are today."</em>
      </p>
      <p>
      ...
      <ul>
        <li><strong>Show, don't summarize.</strong> The prompt is asking for the environment itself, not a thesis statement about what you learned from it.</li>
        <li><strong>Start with concrete particulars.</strong> The texture of a specific morning in your childhood tells Dartmouth more than any abstract claim about your upbringing.</li>
      ...
      <h2>What Strong "Let Your Life Speak" Essays Share</h2>
      <p>
      ...
      <ul>
        <li><strong>Writing a thesis statement at the top.</strong> Sentences like "The environment I grew up in taught me the value of hard work" are the exact opposite of what the prompt is asking for. Delete every thesis sentence.</li>
        <li><strong>Using the essay to describe a struggle-to-success arc.</strong> Adversity narratives can work in a Common App essay but rarely work here. The prompt is about the environment itself, not about overcoming it.</li>
        <li><strong>Describing "my family" in the abstract.</strong> "My parents always encouraged me" is too general to be useful. Specific moments beat general claims every time in this prompt.</li>
        <li><strong>Mentioning Dartmouth.</strong> This essay is not about why you want Dartmouth. Your Why Dartmouth essay does that job. Mentioning Dartmouth here wastes words on the wrong prompt.</li>
        <li><strong>Explaining what the environment means.</strong> The prompt is built around the Quaker principle that life speaks without needing a narrator. If you are narrating the meaning of your own environment, you are speaking over it.</li>
        <li><strong>Relying on platitudes about "my heritage" or "my culture."</strong> These words are flags for admissions readers. They signal that the writer hasn't yet found the specific version of the story that only they could tell.</li>
        <li><strong>Overlapping with your Common App essay.</strong> If your personal statement is about your grandmother, your Dartmouth "Let Your Life Speak" essay should probably be about something else. Dartmouth reads the whole application as a set.</li>
      </ul>

      <h2>The Sentence That Almost Always Signals a Strong Essay</h2>
      <p>
