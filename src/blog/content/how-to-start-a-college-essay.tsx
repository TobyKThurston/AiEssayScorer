...
export default function Content() {
  return (
    <>
      <h2>Why Your Opening Line Does More Work Than Any Other Sentence</h2>
      <p>
      ...
      <h2>The Three Jobs an Opening Line Has to Do</h2>
      <p>
        A working opening line does three things at once. Miss any one of them and the essay starts at a disadvantage.
      </p>
      <ul>
        <li><strong>Establish voice.</strong> In one sentence, the reader should get a sense of who is writing. Are you precise? Dry? Observant? Warm? Voice is not style; it's the fingerprint of how you think. The reader should feel a specific mind behind the sentence.</li>
        <li><strong>Create forward momentum.</strong> The sentence has to make the next one necessary. If the reader could stop after your first line without losing anything, the line isn't pulling its weight. Good openings open questions; they don't close them.</li>
        <li><strong>Hint at what the essay is really about without announcing it.</strong> The best openings gesture at the essay's true subject obliquely. Not "This essay is about my grandfather," but a sentence that makes the grandfather inevitable without naming him.</li>
      </ul>
      <p>
      ...
      <h2>The Five Types of Openings That Consistently Work</h2>
      <p>
      ...
      <h3>1. In-Scene (In Medias Res)</h3>
      <p>
      ...
      <h3>2. A Specific Object or Image</h3>
      <p>
      ...
      <h3>3. An Unexpected Observation</h3>
      <p>
      ...
      <h3>4. A Quiet Declarative Sentence</h3>
      <p>
      ...
      <h3>5. A Question to Yourself (Not to the Reader)</h3>
      <p>
      ...
      <h2>Opening Types That Almost Never Work</h2>
      <p>
      ...
      <ul>
        <li><strong>The dictionary definition ("Webster's defines…"):</strong> Signals that the writer couldn't find their own way into the topic and reached for a textbook. Admissions officers have read this opening thousands of times. It is never surprising.</li>
        <li><strong>The Big Quote from a famous person:</strong> Signals that the writer thinks Gandhi or Einstein will make them sound smarter. It does the opposite, it delays your actual voice and buries you under someone else's. Your essay should start in your own words.</li>
        <li><strong>The rhetorical question to the reader ("Have you ever wondered…"):</strong> Signals that the writer is not confident the subject is interesting on its own. Strong essays don't ask permission to matter.</li>
        <li><strong>The "I have always loved…" opening:</strong> Signals a generic essay about passion. It commits you to a cliché about lifelong dedication and usually isn't even true, most "always loves" started in eighth grade.</li>
        <li><strong>The thesis-statement opening ("In this essay, I will…"):</strong> Signals that the writer is treating the essay like a five-paragraph academic assignment. College essays are not argumentative papers. Announcing your argument kills the one thing personal essays have going for them: discovery.</li>
        <li><strong>The moment of physical stillness opening ("I sat in my car…"):</strong> Signals that the writer read an essay guide that told them to start with a scene, and grabbed the nearest one. Almost every student has an "I sat in my car, thinking about everything that had happened" draft. Readers recognize it immediately.</li>
        <li><strong>The overused setting opening ("The sun rose over…"):</strong> Signals scenic padding. Sunrises, waves crashing, leaves falling, none of these tell the reader anything about you. They're universal by design, and your essay should not be.</li>
        <li><strong>The flashback to early childhood ("When I was five…"):</strong> Signals a coming-of-age narrative that's about to cover ten years in 650 words. Childhood memories can work, but not as the first frame. The essay needs to be rooted in who you are now, not who you were in kindergarten.</li>
        <li><strong>The fake crisis opening ("I was terrified."):</strong> Signals manufactured drama. If the stakes were really that high, the essay will show it. Leading with the emotional verdict robs the reader of getting there on their own.</li>
        <li><strong>The listing-of-traits opening ("I am curious, driven, and…"):</strong> Signals a résumé disguised as an essay. Traits are claims, not evidence. This opening promises that the rest of the essay will tell, not show.</li>
      </ul>

      <h2>The First-Paragraph Formula That Works Across Essay Types</h2>
      <p>
      ...
      <ul>
        <li><strong>Establish voice.</strong> The first sentence or two should feel unmistakably like the person who wrote them. Specific diction, a distinct rhythm, a particular angle on the subject.</li>
        <li><strong>Introduce the tension or question.</strong> The paragraph should make clear, even if only implicitly, what the essay is wrestling with. Not the topic, but the friction inside the topic.</li>
        <li><strong>Land in a place that implies what's coming.</strong> The last sentence of the first paragraph should create a pull into paragraph two. It should raise a question the rest of the essay is going to answer.</li>
      </ul>
      <p>
      ...
      <h2>How to Know If Your Opening Is Actually Working</h2>
      <p>
      ...
      <ul>
        <li><strong>The blind test.</strong> Give someone your first three sentences, with no context. Ask what they think the essay is going to be about. If they can't tell at all, your opening is too vague. If they can summarize the whole essay perfectly, your opening is too on-the-nose. You want them to have a strong guess with some room for surprise.</li>
        <li><strong>The interest test.</strong> Would you, honestly, keep reading past the first paragraph if this essay showed up in a stack of fifty? Not out of obligation, but because the writing pulled you forward. Be ruthless. If the answer is no, the opening needs work.</li>
        <li><strong>The voice test.</strong> Does the opening sound like you, or does it sound like "essay voice," that slightly stiff, slightly formal mode that students slip into when they're trying to sound impressive? Read it out loud. If you wouldn't say it in a conversation, rewrite it until you would.</li>
      </ul>

      <h2>The Common App Personal Statement vs. Supplemental Essays</h2>
      <p>
      ...
      <h2>How to Generate Opening Candidates</h2>
      <p>
      ...
      <ul>
        <li>One in-scene opening.</li>
        <li>One that starts with a specific object or image.</li>
        <li>One unexpected observation.</li>
        <li>One quiet declarative sentence.</li>
        <li>One question the writer is asking themselves.</li>
      </ul>
      <p>
      ...
      <h2>The "Start at Paragraph Two" Trick</h2>
      <p>
      ...
      <h2>What to Do When Your Opening Keeps Getting Cut by Readers</h2>
      <p>
      ...
      <ul>
        <li><strong>Personal statement (Common App):</strong> You have the most room here, 650 words. Voice-driven openings work best. In-scene, specific object, or unexpected observation are the strongest three choices. The opening can unfold over two or three sentences.</li>
        <li><strong>Why this college:</strong> Do not start with the school. Everyone starts with the school. Start with the intellectual pursuit, the question, the course, the problem you've been trying to figure out, and let the school enter as the answer. The school should feel inevitable, not announced.</li>
        <li><strong>Community essay:</strong> Start inside a specific moment from within the community, not a definition of the community. "My family is full of immigrants" is not a community essay opening. "The first argument at Thanksgiving is always about sugar" is.</li>
        <li><strong>Why this major:</strong> The origin question, but oblique. Don't start with "I've always loved biology." Start with the specific moment or problem that made you realize biology was the lens you wanted, then let the essay do the work of showing why.</li>
        <li><strong>Extracurricular essay:</strong> In-scene. The activity in motion, not a summary of what it is. The reader should learn what the activity is by watching you inside it, not by being told.</li>
      </ul>
      ...
      <p>
        Once you have a draft opening you're reasonably happy with, run it through the <Link href="/editor" className="text-[#6366F1] hover:underline">essay editor</Link> to get line-by-line feedback on voice, specificity, and momentum in the first paragraph. For deeper work specifically on opening lines, see our guide to <Link href="/blog/college-essay-hooks-opening-lines" className="text-[#6366F1] hover:underline">college essay hooks and opening lines</Link>. For a full walkthrough of the Common App personal statement, including how openings fit into the larger structure, read <Link href="/blog/how-to-write-common-app-essay" className="text-[#6366F1] hover:underline">how to write the Common App essay</Link>. And if you're working on a supplement with a tight word limit, our guide to the <Link href="/blog/college-essay-word-limit" className="text-[#6366F1] hover:underline">college essay word limit</Link> covers how openings need to change as the word count shrinks.
      </p>
    </>
  );
}
