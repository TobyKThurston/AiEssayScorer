...
export default function Content() {
  return (
    <>
      <h2>What the Additional Information Section Actually Is</h2>
      <p>
      ...
      <h2>When You Should Use Additional Information</h2>
      <p>There are a limited number of situations where this section genuinely helps your application. Use it for:</p>
      <ul>
        <li>
          <strong>Significant time off school.</strong> An illness, hospitalization, family emergency, or bereavement that caused you to miss weeks or months of school. The reader sees an absence on the transcript or a drop in grades, and they need to understand why.
        </li>
        <li>
        ...
        <li>
          <strong>A research project or long-term commitment that needs more space.</strong> The 150-character activity description cannot hold the methodology, institution, timeline, and outcome of a three-year research project. Use this space to give the reader a clean summary.
        </li>
        <li>
          <strong>An injury or illness that explains a drop in grades or extracurriculars.</strong> A concussion, surgery, chronic condition flare-up, or mental health episode that visibly affected one semester of your record.
        </li>
      </ul>

      <h2>When You Should NOT Use It</h2>
      <p>These are the most common misuses of this section. Avoid all of them:</p>
      <ul>
        <li>
          <strong>To add another essay you felt like writing.</strong> If the topic belongs in a supplemental essay, put it in a supplemental essay. This is not a bonus personal statement.
        </li>
        <li>
          <strong>To re-explain something already clear from your application.</strong> If your transcript already shows the AP courses and your activities list already shows the leadership, a paragraph summarizing both is pure redundancy.
        </li>
        <li>
        ...
        <li>
          <strong>To write a second personal statement.</strong> The reader already has one.
        </li>
        <li>
      ...
      <h2>The Medical and Mental Health Question</h2>
      <p>
      ...
      <h2>How to Write About a Learning Difference or Disability</h2>
      <p>
      ...
      <ul>
        ...
        <li>Writing about a topic only because you ran out of space in your supplements.</li>
      </ul>
