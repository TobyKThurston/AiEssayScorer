...
export default function Content() {
  return (
    <>
      <h2>What the Morehead-Cain Is (And How It Differs From Other Scholarships)</h2>
      <p>
      ...
      <p>
        The Morehead-Cain reader is screening for leadership potential,
        intellectual curiosity, and cohort readiness. They want to know
        whether you will show up to Outward Bound and engage with it,
        whether your service summer will be designed thoughtfully, whether
        you will treat inquiry as a real mode rather than a requirement.
        These are specific questions, and the essays are built to answer
        them.
      </p>
      <p>
        Treating the essays as interchangeable with your UNC supplements
        is the most common strategic error. The content has to earn its
        place in a Morehead-Cain folder, not a UNC folder.
      </p>

      <h2>What Morehead-Cain Admissions Is Actually Screening For</h2>
      <p>
        Underneath the specific prompts, the selection committee is reading
        for a consistent set of traits. These are the signals that matter
        across every essay:
      </p>
      <ul>
        <li>
          <strong>Leadership in action, not in titles.</strong> Committees
          see hundreds of "captain of the team, president of the club"
          resumes. They read for moments where you made a decision under
          pressure, changed a group's direction, or took responsibility no
          one assigned you. A title is a label. Leadership is a verb.
        </li>
        <li>
          <strong>A real service orientation.</strong> The foundation funds
        ...
        <li>
          <strong>Intellectual breadth.</strong> Scholars are expected to
          move across disciplines. A Scholar whose curiosity has one
          frequency will struggle in a cohort built on range. The essays
          should reveal a mind that reads, notices, and connects.
        </li>
        <li>
          <strong>Voice that signals cohort fit.</strong> Your voice on the
          page is a proxy for the person who will show up at a cohort
          dinner. Warmth, humor, directness, and self-awareness read as
          cohort-ready. Stiffness and self-importance do not.
        </li>
        <li>
          <strong>Evidence you would thrive in the Discovery Experience.</strong>{" "}
          A Scholar who resents outdoor leadership, dreads service, avoids
          inquiry, and sees private enterprise as the only real summer is
          a bad match. The essays should reveal a person who would engage
          with all four.
        </li>
        <li>
          <strong>Maturity.</strong> The foundation is handing
          eighteen-year-olds significant money and significant autonomy.
          Maturity shows up in the ability to describe your own mistakes,
          to write about other people with generosity, and to handle an
          abstract prompt without floating into abstraction.
        </li>
      </ul>

      <h2>The "Topic That Captivates You" Essay: Structure</h2>
      <p>
      ...
      <p>
        This is the most dangerous prompt on the application because it
        invites abstraction. The applicant who writes "success is not
        money, success is happiness, success is impact" has already lost.
        Those sentences could be written by anyone. The reader skims past
        them.
      </p>
      <p>
      ...
      <ul>
        <li>
          <strong>Writing resume-heavy essays.</strong> The committee
          already has your activities list, nomination letter, and
          transcript. Restating accomplishments in prose wastes the
          essay's only job.
        </li>
        <li>
        ...
        <li>
          <strong>Abstract philosophy without lived material.</strong>{" "}
          "Success is defined by impact on others." That sentence has been
          written by every applicant since the prompt was invented. It
          signals nothing. A moment signals everything.
        </li>
        <li>
          <strong>Treating the essays as interchangeable with UNC
          supplements.</strong> The audience and rubric differ. An essay
          written for UNC admissions will read as off-register to a
          Morehead-Cain reader.
        </li>
        <li>
          <strong>Not demonstrating cohort readiness.</strong> If nothing
          in your essays suggests you would be a generous, curious, or
          grounded person to spend four years with, the reader has no
          reason to put you in the class. Warmth is structural.
        </li>
        <li>
          <strong>Self-aggrandizing stories.</strong> Essays where the
          writer is the hero of every scene and every conflict resolves
          in the writer's favor read as brittle. Maturity shows up in the
          way you describe people who were right when you were wrong.
        </li>
        <li>
          <strong>Missing the Morehead-Cain culture.</strong> Essays that
          betray no outdoor willingness, no service instinct, no inquiry
          reflex make it hard for the committee to picture you in the
          program. You do not have to name the Discovery Experience. You
      ...
      <h2>How the Morehead-Cain Application Coordinates With Your UNC Admissions</h2>
      <p>
      ...
      <p>
        ...
        prompt has a real scene inside it. For the parallel UNC supplement,
        our{" "}
        <Link
