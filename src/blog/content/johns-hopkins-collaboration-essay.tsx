...
export default function Content() {
  return (
    <>
      <h2>The Johns Hopkins Prompt, Verbatim</h2>
      <p>
        Johns Hopkins's supplemental essay asks: <em>"Tell us about an aspect of your identity (e.g. race, gender, sexuality, religion, community, etc.) or a life experience, opinion, or interest that has shaped who you are today and how it might contribute to our Hopkins community."</em> The target length is around 350 words — short enough that every sentence has to work, long enough that there's room for a real example.
      </p>
      <p>
      ...
      <h2>Why Hopkins Frames Everything Around Collaboration</h2>
      <p>
      ...
      <h2>What Hopkins Admissions Screens For</h2>
      <ul>
        <li><strong>Evidence of collaborative thinking in your past.</strong> Not "I was on a team" — specific moments where working with other people changed how you thought about a problem. Hopkins wants to see that collaboration has already shaped your mind.</li>
        <li><strong>Self-awareness about how you show up in groups.</strong> Are you the connector, the translator, the questioner, the builder? The essay should make your role legible without forcing the applicant to announce it.</li>
        <li><strong>A specific identity, experience, opinion, or interest with substance.</strong> Vague identity claims read as performance. Specific ones — a family role, a subculture, an intellectual commitment, an unusual interest — read as real.</li>
        <li><strong>Writing that moves beyond the self to include the people around you.</strong> A Hopkins essay that never mentions other human beings is almost certainly off-prompt.</li>
        <li><strong>Ambition grounded in community rather than solo achievement.</strong> The closing beats that land at Hopkins describe what you want to do with others there, not what you want to achieve alone.</li>
      </ul>

      <h2>The Trap of the "Identity" Word</h2>
      <p>
      ...
      <ol>
        <li><strong>Name the identity, experience, opinion, or interest with concrete specificity (2–3 sentences, 50–70 words).</strong> Not "I come from a bicultural family" — the specific texture of that, or whatever your equivalent is. Open with something only you could write.</li>
        <li><strong>Show how it has shaped the way you engage with others (1–2 paragraphs, 180–220 words).</strong> This is the Hopkins-specific move. The middle of the essay is not about who you are in isolation; it is about how who you are changes the way you show up in groups. Use a specific example — a moment, a project, a relationship — where this quality did real work.</li>
        <li><strong>Close with how it would manifest at Hopkins concretely (2–3 sentences, 60–80 words).</strong> Not "I can't wait to be part of the Hopkins community." Name a specific setting — a lab, a student org, an interdisciplinary institute, a type of seminar — and describe what you'd bring to it as a collaborator.</li>
      </ol>

      <h2>What Strong Hopkins Essays Do</h2>
      <p>
      ...
      <ul>
        <li><strong>Listing identities without showing how they shape behavior.</strong> "I am a first-generation Vietnamese-American woman" tells the committee nothing about how you engage with others. Identity without behavior is inert.</li>
        <li><strong>Making the essay about the self alone, with no collaborative dimension.</strong> If the middle of your essay never mentions another human being, you are not answering the Hopkins prompt.</li>
        <li><strong>Writing about your intended major instead of your identity.</strong> The Why Major content belongs in a different essay. This one is about who you are and how you work with others.</li>
        <li><strong>Performing marginalization.</strong> Essays that lean on hardship as the whole substance of the identity read as performance. Hopkins is not looking for trauma; it is looking for self-awareness.</li>
        <li><strong>Using "diverse perspectives" or "multicultural" as empty signifiers.</strong> These phrases are stamps, not arguments. Cut them.</li>
        <li><strong>Mentioning Hopkins only in the closing sentence.</strong> If the Hopkins content is a single tacked-on line, the essay reads as a personal statement retrofit. The closing should be genuinely Hopkins-shaped.</li>
        <li><strong>Claiming interdisciplinary thinking without evidence.</strong> "I love connecting ideas across fields" is theater. Show one actual connection you've made between two fields, or cut the claim.</li>
      </ul>

      <h2>The Hopkins-Specific Move: From Self to Collaboration</h2>
      <p>
      ...
      <ul>
        <li><em>"What this gave me, eventually, was a specific way of being in group conversations: I notice first what isn't being said."</em></li>
        <li><em>"The practical effect of growing up this way is that I treat disagreement as data rather than conflict."</em></li>
        <li><em>"I didn't realize until later that it had trained me to be the person in the room who asks the second question — the one past the first easy answer."</em></li>
      </ul>
      <p>
      ...
      <h2>How the Essay Fits With the Rest of Your Hopkins Application</h2>
      <p>
      ...
      <p>
        Before submitting, run your Hopkins essay through our <Link href="/editor" className="text-oxblood hover:underline">AI essay review tool</Link> for line-by-line feedback on the collaboration move. For how other highly community-oriented Ivies handle their prompts, see our <Link href="/blog/yale-community-essay" className="text-oxblood hover:underline">Yale community essay guide</Link> and our <Link href="/blog/upenn-community-essay" className="text-oxblood hover:underline">Penn community essay guide</Link>. For broader patterns across the most selective schools, read our <Link href="/blog/ivy-league-essay-tips" className="text-oxblood hover:underline">Ivy League essay analysis</Link>.
      </p>
    </>
  );
}
