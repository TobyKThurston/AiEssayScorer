...
export default function Content() {
  return (
    <>
      ...
      <p>
        Before submitting, run your Hopkins essay through our <Link href="/editor" className="text-[#6366F1] hover:underline">AI essay review tool</Link> for line-by-line feedback on the collaboration move. For how other highly community-oriented Ivies handle their prompts, see our <Link href="/blog/yale-community-essay" className="text-[#6366F1] hover:underline">Yale community essay guide</Link> and our <Link href="/blog/upenn-community-essay" className="text-[#6366F1] hover:underline">Penn community essay guide</Link>. For broader patterns across the most selective schools, read our <Link href="/blog/ivy-league-essay-tips" className="text-[#6366F1] hover:underline">Ivy League essay analysis</Link>.
      </p>
    </>
  );
}
