...
export default function Content() {
  return (
    <>
      <h2>The Duke Why Prompt, Verbatim</h2>
      <p>
        Duke asks applicants: <em>"What is your sense of Duke as a university and a community, and why do you consider it a good match for you? If there's something in particular about our curriculum, your potential major, scholarly interests, or campus life that attracts you, feel free to share that as well."</em> The limit is 250 words.
      </p>
      <p>
      ...
      <h2>Why Duke's Interdisciplinary Focus Changes the Strategy</h2>
      <p>
      ...
      <h2>What Duke Admissions Is Screening For</h2>
      <p>
      ...
      <ul>
        <li><strong>Genuine interest in combining fields in a way that Duke's structure supports.</strong> Duke's academic identity is built around the idea that disciplines interact. If you write about wanting to study a single subject in isolation, you're not matching the institution. The committee wants to see that you have an intellectual question that requires more than one department to answer, and that you've identified how Duke's specific programs let you work across those boundaries.</li>
        <li><strong>Understanding of Trinity vs. Pratt and which one you belong in.</strong> This is a surprisingly common failure point. Trinity is the liberal arts college; Pratt is the engineering school. They share the same campus and many resources, but they have different degree requirements, different academic cultures, and different admissions processes. If your essay confuses them, or if you write about engineering programs while applying to Trinity, you signal that you haven't done basic research. Know which school you're applying to and why.</li>
        <li><strong>A sense that you'd use Duke's resources to do something specific.</strong> "I want to explore broadly" is the wrong answer at Duke. Duke values intellectual range, but it values directed range — combining disciplines to address a particular problem, not sampling courses without purpose. The committee wants evidence that you have a destination, even if the path might change.</li>
      </ul>
      ...
      <ol>
        <li><strong>Open with what you want to work on at Duke — a specific intellectual goal (2–3 sentences).</strong> Not "I want to study economics." Rather: "I want to understand why microfinance programs succeed in some regulatory environments and fail in others." Lead with the question, not the major. This immediately signals to the committee that your interest has shape and direction.</li>
        <li><strong>Name the Duke-specific resources that serve that goal (3–4 sentences).</strong> Be concrete. Mention specific courses by number or name if you've found them. Name a Bass Connections project team, not just "Bass Connections." Reference a faculty member's research and explain how it connects to yours. Cite a specific center — the Kenan Institute for Ethics, the Social Science Research Institute, the Energy Initiative — and say what you'd do there. Generic program names waste words. Specifics prove research.</li>
        <li><strong>Close with what you'd bring to Duke — contribution, not just consumption (1–2 sentences).</strong> Duke's prompt asks about mutual fit. After explaining what you'd take from Duke, tell them what you'd give. This could be a research perspective, a skill set, a community you'd build, or a project you'd launch. Keep it brief and grounded — one concrete contribution beats three vague ones.</li>
      </ol>

      <h2>What Strong Duke Why Essays Do</h2>
      <p>
      ...
      <blockquote>
        ...
        Duke's Global Health Institute is one of the few programs that treats health policy as inseparable from field research. The Bass Connections project team on 'Improving Child and Family Health and Well-Being' would let me combine epidemiological methods with community-based fieldwork while still an undergraduate. I'd pair a Global Health major in Trinity with the Policy Analysis and Management certificate, and I'm drawn to Professor Gavin Yamey's work on financing health interventions in low-resource settings — his framework for understanding political priority is the closest match I've found for the questions I'm trying to answer.

        I'd bring two years of community health data from my screening project and a working relationship with the county health department that could become a Bass Connections partnership."
      </blockquote>
      <p>
      ...
      <ul>
        <li><strong>Mentioning Duke basketball.</strong> The committee does not need to hear that Cameron Indoor Stadium gave you chills. Athletic culture is not academic fit. Unless your essay is about sports analytics research, leave basketball out.</li>
        <li><strong>Writing about Durham instead of Duke's academics.</strong> Durham is a great city. But "I love Durham's food scene" and "I'm excited about the Research Triangle" are not answers to why Duke specifically is the right school for your intellectual goals. The prompt asks about Duke as a university, not as a zip code.</li>
        <li><strong>Listing Bass Connections without specifics.</strong> "I'm excited about Bass Connections because it's interdisciplinary" is the single most common waste of space in Duke Why essays. Name the specific project team, the specific theme, or the specific faculty lead. If you can't, you haven't researched it enough to mention it.</li>
        <li><strong>Confusing Trinity and Pratt.</strong> Writing about engineering design courses when you're applying to Trinity, or referencing liberal arts breadth requirements when you're applying to Pratt, tells the committee you don't understand Duke's structure. Know which school you're in and write accordingly.</li>
        <li><strong>Name-dropping DukeEngage without a specific vision.</strong> DukeEngage is Duke's signature civic engagement program, and it appears on every campus tour. Mentioning it generically — "I'd love to do DukeEngage" — says nothing. Specify which type of project, which region, which problem, and how it connects to your academic work.</li>
        <li><strong>Writing about Duke's "collaborative culture" without evidence.</strong> Every selective school claims to be collaborative. Asserting that Duke has a collaborative culture is not a Duke-specific statement. If you want to reference community, point to a specific structure — a residential program, a student organization, a research group — that embodies what you mean.</li>
      </ul>

      <h2>The Duke-Specific Test</h2>
      <p>
