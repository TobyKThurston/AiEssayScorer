...
export default function Content() {
  return (
    <>
      <h2>The MIT Prompt, Verbatim</h2>
      <p>
        One of MIT's five short-answer essays reads: <em>"Tell us about something you do simply for the pleasure of it."</em> The word limit is 200 words.
      </p>
      <p>
      ...
      <h2>Why MIT Asks This Question</h2>
      <p>
      ...
      <h2>What Strong MIT Pleasure Essays Actually Do</h2>
      <p>
        Here is the shape of a pleasure essay that works:
      </p>
      <blockquote>
        "Every Saturday I wake up at 5 a.m. to bake bread. Not because I need to — my family would survive on store-bought — but because I like the way the house smells before anyone else is awake. I measure the flour by weight, not volume, because my first ten loaves came out wrong and I learned that precision matters even when the stakes are zero. I knead for exactly twelve minutes because that's how long the album I listen to takes to reach my favorite track. The dough is warm. The kitchen is cold. I shape the loaf, score the top with a razor blade, and slide it into a Dutch oven that's been heating for an hour.

        By 7 a.m. the bread is done and I eat the first slice standing at the counter with butter and salt. It is the only thing I do all week where the result is completely mine — no grade, no team, no audience. Just bread."
      </blockquote>
      <p>
      ...
      <ul>
        <li><strong>Choosing something that sounds impressive rather than genuinely pleasurable.</strong> If you picked this activity because you think MIT will be impressed by it, you've already failed the prompt. The admissions committee can detect the difference between "I do this because I love it" and "I'm describing this because it makes me look interesting." The first is honest. The second is strategy, and strategy is exactly what this essay should not be.</li>
        <li><strong>Connecting the activity to your intended major.</strong> "I bake bread, and the chemistry of fermentation is actually what drew me to chemical engineering." No. The moment you connect the pleasure to your academic identity, you've turned a personal essay into a disguised Why Major essay. MIT gave you other essays for that. This one is off-limits for academic positioning.</li>
        <li><strong>Writing about competitive activities.</strong> If you compete in the thing — if there are rankings, tournaments, trophies, or scores — then it is not something you do "simply for the pleasure of it." Competition introduces stakes, evaluation, and external motivation. All three disqualify the activity from this prompt. You can love competing, but that love belongs in a different essay.</li>
        <li><strong>The meta-essay about how this activity taught you perseverance.</strong> This is the most common structural failure. The applicant describes a pleasurable activity for 100 words and then spends 100 words explaining what it "taught" them — patience, discipline, the value of process over product. MIT did not ask what the activity taught you. They asked what you do for pleasure. Answer the question they asked.</li>
        <li><strong>Mentioning MIT anywhere in the essay.</strong> "This is why I'd thrive at MIT" or "I hope to continue this at MIT" — both are wrong. This prompt is about you, not about MIT. Any mention of the school signals that you're treating every essay as a pitch rather than an answer.</li>
      </ul>

      <h2>The Pleasure Test</h2>
      <p>
