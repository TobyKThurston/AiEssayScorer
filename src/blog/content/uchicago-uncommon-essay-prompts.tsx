...
export default function Content() {
  return (
    <>
      <h2>What the UChicago Uncommon Essay Is, and Why It Exists</h2>
      <p>
      ...
      <h2>Examples of Past Uncommon Prompts</h2>
      <p>
      ...
      <ul>
        <li><em>"Find x."</em></li>
        <li><em>"What can be divided by zero?"</em></li>
        <li><em>"Where's Waldo, really?"</em></li>
        <li><em>"A hot dog might be a sandwich, and cereal might be a soup, but is a ______ a ______?"</em></li>
        <li><em>"Vestigiality refers to genetically determined structures or attributes that have lost most or all of their ancestral function, but have been retained during the process of evolution. In humans, for instance, the appendix is thought by scientists to be a vestigial structure. Describe something vestigial (real or imagined) and provide an explanation for its existence."</em></li>
        <li><em>"Mantis shrimp can perceive many more colors than humans can. Cats can distinguish between lower light levels. But what about taste? Sound? If you could develop a new sense, describe it."</em></li>
        <li><em>"What's so easy about pie?"</em></li>
        <li><em>"Have you ever walked through the aisles of a warehouse store like Costco or Sam's Club and wondered who would buy a jar of mustard a foot and a half tall? We've bought it, but it didn't stop us from wondering about other things, like absurd eating contests, impulse buys, excess, unimagined uses for mustard, storage, preservatives, notions of bigness… and dozens of other ideas both silly and serious. Take an ordinary object, think about six unrelated things it could stand for, and explain."</em></li>
      </ul>
      <p>
      ...
      <h2>The Central Misunderstanding</h2>
      <p>
      ...
      <ul>
        <li><strong>Genuine intellectual playfulness.</strong> Can you take an absurd premise seriously without losing your sense of humor? The essay is a test of whether you can hold "this is a game" and "this is real" at the same time.</li>
        <li><strong>Willingness to follow an idea somewhere unpredictable.</strong> Strong essays turn. They start in one place and end somewhere the opening didn't promise. Readers are watching for whether your mind moves.</li>
        <li><strong>Comfort with ambiguity.</strong> The prompts don't have correct answers. Applicants who need a correct answer to write well tend to seize up.</li>
        <li><strong>Evidence that you think in connections and analogies.</strong> Most UChicago essays that work involve an unexpected link between two things the reader didn't see as related. That habit of mind is specifically what the prompts are designed to catch.</li>
        <li><strong>A writing voice that isn't trying to sound mature.</strong> UChicago is a research university with a seminar culture. Voices that sound like seventeen-year-olds thinking out loud do better than voices that sound like thirty-five-year-old columnists.</li>
        <li><strong>A willingness to be strange rather than impressive.</strong> This is the deepest filter. Most applicants default to trying to look good. UChicago rewards applicants who would rather be interesting.</li>
      </ul>

      <h2>How to Pick a Prompt</h2>
      <p>
      ...
      <h2>The "Create Your Own Prompt" Trap</h2>
      <p>
      ...
      <ol>
        <li><strong>An opening that takes the prompt seriously in an unexpected way (100–200 words).</strong> Not a hook, not a joke, not a scene - a specific, slightly surprising reading of the prompt itself. The opening is where you signal that you're going to engage with the prompt rather than dodge it. It's also where your voice establishes itself.</li>
        <li><strong>A middle that follows the idea somewhere unpredictable (400–600 words).</strong> This is where the essay actually happens. The idea has to move. Strong middles usually involve a turn - a moment where the essay connects to something personal without announcing the connection. The worst middles are ones that stay at the same level of abstraction throughout. The best ones zoom in and out.</li>
        <li><strong>A close that doesn't resolve the essay so much as land in a new place (100–200 words).</strong> UChicago essays shouldn't end with a moral. They should end with the reader realizing they're somewhere they didn't expect to be. A good close feels like the natural next thought, not a conclusion.</li>
      </ol>
      <p>
      ...
      <h2>What Strong UChicago Essays Actually Do</h2>
      <p>
      ...
      <ul>
        <li><strong>Trying too hard to be quirky.</strong> A forced weird voice reads as performance within the first paragraph. Admissions readers have a very high bar for what counts as genuinely strange.</li>
        <li><strong>Writing a creative writing piece that reveals nothing about the writer.</strong> Fiction, fables, and surrealist vignettes almost always fail because UChicago is not a creative writing contest. The essay has to let the reader in.</li>
        <li><strong>Answering the prompt directly and literally.</strong> "Find x" is not actually asking you to find x. An essay that reads as an earnest attempt to solve the prompt's surface question has missed the invitation.</li>
        <li><strong>Forcing a connection to your intended major.</strong> The prompt is not a "why this major" essay in disguise. Readers can feel when the essay is being steered toward a pre-written conclusion.</li>
        <li><strong>Piling on references to sound erudite.</strong> Dropping names of philosophers, French films, and obscure theorems does not land as sophistication. It lands as insecurity.</li>
        <li><strong>Using the essay to complain about how hard it was to write.</strong> Meta-complaints about the prompt are never interesting and always read as stalling.</li>
        <li><strong>Making the essay about writing the essay.</strong> "I stared at this prompt for hours…" This opening appears in roughly one in twenty UChicago essays. It has never worked.</li>
        <li><strong>Copying the style of a published uncommon essay you read online.</strong> The famous UChicago essays that go viral each year are famous because they are one-of-a-kind. Imitating them produces a second-rate version of a first-rate essay.</li>
      </ul>

      <h2>The Voice Question</h2>
      <p>
      ...
      <p>
        <strong>The Stand-Up Comedian.</strong> The applicant treats the prompt as a setup for jokes. The essay becomes a string of one-liners with no underlying thought. This register fails because comedy without substance is the most forgettable thing a reader encounters.
      </p>
      <p>
        <strong>The Sophomore Philosopher.</strong> The applicant treats the prompt as a platform for Big Ideas. The essay invokes consciousness, authenticity, the human condition, and Heidegger. This register fails because the reader has seen the same gestures a thousand times, and the prompt is specifically designed to resist them.
      </p>
      <p>
        <strong>The Earnest High-Schooler.</strong> The applicant treats the prompt as a chance to demonstrate good character. The essay becomes sincere, heartfelt, and deeply uninteresting. This register fails because UChicago is not screening for good character in this essay - they're screening for a mind.
      </p>
      <p>
      ...
      <h2>How Long Should It Actually Be?</h2>
      <p>
