...
export default function Content() {
  return (
    <>
      <h2>Why "Topics to Avoid" Is the Wrong Frame, Mostly</h2>
      <p>
      ...
      <h2>The Topic Quality You Actually Want</h2>
      <p>
      ...
      <h2>The 12 Topics That Usually Backfire</h2>
      <p>
      ...
      <h3>3. The Grandparent's Death</h3>
      <p>
      ...
      <h3>4. The Move to a New Country</h3>
      <p>
      ...
      <h3>6. The Sports Championship (Won or Lost)</h3>
      <p>
      ...
      <h3>7. The Volunteer Work Essay (When You Volunteered Once)</h3>
      <p>
      ...
      <h3>8. The "I Learned to Be Grateful"</h3>
      <p>
      ...
      <h3>9. The Model UN / Debate Round Revelation</h3>
      <p>
      ...
      <h3>10. The "Discovering My Passion for [STEM Field]"</h3>
      <p>
      ...
      <h3>11. The COVID/Pandemic Essay</h3>
      <p>
      ...
      <h3>12. The "Mental Health Journey" Essay</h3>
      <p>
      ...
      <h2>The Topic That's Almost Always the Best: The Small One</h2>
      <p>
      ...
      <h2>How to Tell If Your Topic Is Actually Working</h2>
      <p>
        Three questions. Be honest with yourself.
      </p>
      <p>
        <strong>First: Could another applicant with your background write this exact essay?</strong> If yes, your topic is too generic, or your execution is. A good essay should be impossible to confuse with anyone else's.
      </p>
      <p>
        <strong>Second: Does the essay depend on one specific detail that only you would have?</strong> Not a detail that could be inferred from your context, a detail that is actually yours. If you cannot name that detail, the essay does not yet have one.
      </p>
      <p>
        <strong>Third: If you removed the emotional climax, is there still something worth reading?</strong> If the essay collapses without its dramatic moment, the essay is living on its topic's inherent weight, not on what you brought to it.
      </p>
      <p>
        An essay that passes all three is working. An essay that fails any one of them needs to be rethought, not just revised.
      </p>

      <h2>The "If You Heard This At a Dinner Party" Test</h2>
      <p>
      ...
      <h2>Re-entering a Common Topic the Right Way</h2>
      <p>
      ...
      <h2>What Matters More Than Topic</h2>
      <p>
