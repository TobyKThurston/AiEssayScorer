...
export default function Content() {
  return (
    <>
      <h2>What Separates Accepted Essays From Rejected Ones</h2>
      <p>
      ...
      <h2>Signal 1: Intellectual Texture</h2>
      <p>
      ...
      <ul>
        <li>Not "I've always loved science" → "I spent three summers re-running the same protocol, adjusting one variable at a time, convinced there was a signal in the noise."</li>
        <li>Not "I'm a leader" → "When the team wanted to scrap the project, I spent the weekend building a working prototype so they could see what I was seeing."</li>
      </ul>

      <h2>Signal 3: A Distinctive Voice</h2>
      <p>
      ...
      <h2>Signal 4: Honest Reflection Over Polished Performance</h2>
      <p>
      ...
      <h2>Signal 5: The Essay Does Something the Rest of the Application Can't</h2>
      <p>
      ...
      <h2>What Ivy League Schools Are Not Looking For</h2>
      <ul>
        <li><strong>The tragedy essay.</strong> Hardship can make for a powerful essay, but only when the focus is on the thinking and growth, not the hardship itself. Using suffering as a credential doesn't work.</li>
        <li><strong>The achievement summary.</strong> Listing accomplishments in essay form is a wasted opportunity. Admissions officers have your activities list.</li>
        <li><strong>Flattery.</strong> Essays that spend significant space praising the school are almost always weaker than essays that reveal something about the applicant. Schools know they're good; they want to know why you're right for them.</li>
        <li><strong>Safe topics handled safely.</strong> Sports, music, and volunteering are common topics, not automatically bad ones, but they require an uncommon angle to land.</li>
      </ul>

      <h2>The Revision Process That Changes Essays</h2>
      <p>
      ...
      <p>
        See annotated excerpts from accepted applications in our <Link href="/ivy-league-essay-examples" className="text-oxblood hover:underline">Ivy League essay examples</Link> guide. To apply these patterns to your own draft, run it through our <Link href="/ai-essay-review" className="text-oxblood hover:underline">AI essay review</Link> tool, then use the <Link href="/how-to-improve-college-essay" className="text-oxblood hover:underline">revision guide</Link> to target whichever dimension scores lowest. For school-specific supplemental strategy, see our deep-dives on the <Link href="/blog/columbia-why-columbia-essay-core-curriculum" className="text-oxblood hover:underline">Columbia Why Essay and Core Curriculum</Link> and the <Link href="/blog/columbia-list-essay-what-are-you-reading" className="text-oxblood hover:underline">Columbia list question</Link>.
      </p>
    </>
  );
}
