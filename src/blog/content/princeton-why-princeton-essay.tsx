...
export default function Content() {
  return (
    <>
      <h2>The Princeton "Why Princeton" Prompt, Verbatim</h2>
      <p>
        Princeton's application asks: <em>"Princeton has a longstanding commitment to service and civic engagement. Tell us how your story intersects with these ideals and why you wish to pursue your education at Princeton."</em> The word limit is approximately 250 words.
      </p>
      <p>
      ...
      <h2>What Princeton Admissions Is Screening For</h2>
      <p>
      ...
      <ul>
        <li><strong>A genuine service or civic engagement track record.</strong> Not a one-time volunteer project. A pattern of engagement that shows sustained interest in a specific problem or community. The committee can distinguish between service that shaped your thinking and service that padded your resume.</li>
        <li><strong>Specific Princeton resources that connect to your engagement.</strong> Not "Princeton's amazing faculty." Name the Pace Center program, the specific community-based course, the professor whose policy research intersects with your work, the student organization that does what you want to do next. Princeton-specific content is what separates a Why Princeton essay from a generic service essay.</li>
        <li><strong>Evidence that you've researched Princeton beyond the admissions website.</strong> Reading the Princeton course catalog, department pages, the Daily Princetonian, and faculty research profiles all leave marks on the essay that generic browsing does not.</li>
      </ul>

      <h2>What to Cut From a Princeton Why Essay</h2>
      <p>
        At 250 words, every sentence has to earn its place. Delete:
      </p>
      <ul>
        <li><strong>Any sentence about Princeton's prestige, rankings, or Ivy League status.</strong> The committee already knows. This wastes words and signals that you're writing about the brand, not the school.</li>
        <li><strong>Generic claims about "changing the world" or "making a difference."</strong> These phrases are empty calories. Replace them with a specific problem you've already worked on.</li>
        <li><strong>Adjectives describing Princeton as "beautiful," "historic," or "inspiring."</strong> Every one is a word wasted. The campus is gorgeous. The committee knows this too.</li>
        <li><strong>References to eating clubs, Reunions, or campus social life, unless tied to a specific civic engagement point.</strong> The Why essay is about academic and service fit, not social fit.</li>
        <li><strong>The phrase "I would thrive at Princeton."</strong> This claims nothing. Show how you'd use Princeton's specific resources instead.</li>
        <li><strong>Anything that would work in a Why Columbia or Why Yale essay with the school name swapped.</strong> If the sentence is interchangeable, it's generic.</li>
      </ul>
      ...
      <p>
        Before submitting, run your full Princeton supplement through our <Link href="/editor" className="text-oxblood hover:underline">AI essay review tool</Link> for line-by-line feedback on specificity. For how Princeton's service-anchored prompt compares to standard Why essays, see our <Link href="/blog/why-this-college-essay" className="text-oxblood hover:underline">Why This College guide</Link>. To see how other Ivies handle the Why essay differently, read our <Link href="/blog/yale-why-yale-essay-125-words" className="text-oxblood hover:underline">Yale Why essay guide</Link> (125 words), our <Link href="/blog/dartmouth-why-dartmouth-100-words" className="text-oxblood hover:underline">Dartmouth Why essay guide</Link> (100 words), and our <Link href="/blog/columbia-why-columbia-essay-core-curriculum" className="text-oxblood hover:underline">Columbia Why guide</Link> (Core Curriculum focus). For broader patterns across the Ivy League, see our <Link href="/blog/ivy-league-essay-tips" className="text-oxblood hover:underline">Ivy League essay analysis</Link>.
      </p>
    </>
  );
}
