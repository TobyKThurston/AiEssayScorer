...
export default function Content() {
  return (
    <>
      <h2>The Emory "Why Emory" Prompt, Verbatim</h2>
      <p>
        Emory asks:{" "}
        <em>
          "Which aspects of Emory University's community, whether in Atlanta or
          Oxford, appeal to you, and why?"
        </em>{" "}
        The word limit is 150 words.
      </p>
      <p>
        This is one of two Emory supplemental prompts. The other is a personal
        ...
        words. There is no room for interchangeability.
      </p>
      <p>
        The constraint is severe. A hundred and fifty words is roughly eight
        to ten sentences. You cannot explain yourself, sketch a background,
        and demonstrate fit all in the same essay. You have to choose the
        hardest-working content and trust that the rest of the application
        fills in around it. That selection pressure is the point. Emory is
        watching which Emory-specific features you actually chose to name,
        and what that choice reveals about the kind of applicant you are.
      </p>

      <h2>Why This Prompt Is Different From Other "Why" Essays</h2>
      <p>
        The load-bearing phrase in this prompt is six words:{" "}
        ...
        enrolls around 1,400 on a large research campus embedded in a major
        city. The two experiences are radically different for the first two
        years.
      </p>
      <p>
      ...
      <h2>What Emory Admissions Is Actually Screening For</h2>
      <p>
        At 150 words, admissions readers do not have time to decode subtext.
        They are scanning for a short list of signals. The strongest essays
        hit most of them. The forgettable ones hit none.
      </p>
      <ul>
        <li>
          <strong>Correct campus choice, correctly engaged.</strong> If you
          applied to Oxford, the essay has to engage with what makes Oxford
          different from Atlanta. If you applied to Atlanta, the essay has
          to engage with the big-city research ecosystem. Mismatch between
          the campus you applied to and the essay you wrote is the fastest
          disqualifier in the reading process.
        </li>
        <li>
          <strong>Emory-specific naming.</strong> Readers want to see a real
          program, resource, or feature that would not appear in a
          generically assembled Why essay. QTM. Goizueta. Rollins. The Emory
          Center for Ethics. Barkley Forum. Oxford's residential-college
          structure. The Atlanta shuttle. Dooley. Vague gestures toward
          "strong academics" or "diverse city" signal that you did not do
          the work.
        </li>
        <li>
          <strong>Fit between feature and applicant.</strong> Naming
          Goizueta is worth nothing if the rest of your application shows no
          interest in business and the essay does not explain why you would
          wait two years to enter it. Fit requires that the Emory feature
          you named and the student the application describes actually
          belong together.
        </li>
        <li>
        ...
        <li>
          <strong>Evidence of specific pre-professional or intellectual
        ...
        <li>
          <strong>Texture, not polish.</strong> Essays that could have been
          written by a competent copywriter with a campus tour transcript
          are forgettable. Essays that could only have been written by a
          specific person with a specific obsession are remembered.
        </li>
      </ul>
      ...
      <p>
        If you applied to Oxford, your essay has to engage with what Oxford
        actually is: a small residential college, two years in Oxford,
        Georgia, then a transition to the Atlanta campus for junior and
      ...
      <p>
        If you applied to Atlanta, your essay has to engage with what the
      ...
      <p>
        The practical rule:{" "}
        <strong>
          at least one sentence in your essay should be one that the other
          campus's applicant could not have written.
        </strong>{" "}
        If your essay is 150 words and every sentence could be swapped
        between an Atlanta and an Oxford draft without changing meaning,
      ...
      <p>
        At this word count, structure is not optional. A strong Why Emory
        essay makes three moves, in order. Each move has a job and a
        failure mode. If you try to do more than three, the essay collapses
        into a list. If you try to do fewer than three, the essay becomes
        decorative.
      </p>
      <ol>
        <li>
          ...
          the Oxford-to-Atlanta shuttle, Dooley, or the Emory Scholars
          Program. One feature is enough. Two is acceptable if they
          connect. <em>Failure mode:</em> listing four features in a single
          sentence. That reads as a website search, not a reason to attend.
        </li>
        <li>
          <strong>Move two: say what you would do with it.</strong>{" "}
          <em>Job:</em> prove that the feature is not ornamental. A
          sentence about QTM that does not identify a question you would
          ...
          verb choice is specific: "take," "ask," "argue," "shadow,"
          "test," "join."
        </li>
        <li>
          <strong>Move three: say what that choice reveals about
          you.</strong> <em>Job:</em> convert the Why essay into a
          ...
          you have already shown about how you think about business.{" "}
          <em>Failure mode:</em> sentimental closers. "I can't wait to be
          part of the Emory family" is not a third move. It is an escape
          hatch from the third move.
        </li>
      </ol>
      <p>
      ...
      <h2>What a Strong Emory Why Essay Actually Looks Like</h2>
      <p>
        Here is a draft that makes all three moves cleanly inside the word
        limit. It is not a real applicant's essay, but it captures the
        specificity, campus-awareness, and restraint the strongest versions
        share.
      </p>
      <blockquote>
        "I applied to Oxford because I want my first two years to be small
        on purpose. I have been running a weekly reading group for two
        years, and I have learned that I think better in rooms of twelve
        than rooms of a hundred. Oxford's scale, and the shuttle-ride
        ...
        around it. Oxford first, then Atlanta. That shape is why I
        applied."
      </blockquote>
      <p>
        ...
        That is move three completed.
      </p>
      <p>
        Notice what the essay does not do. It does not mention the
        weather, diversity, or Atlanta's food scene. It does not praise
        Emory's "strong academics." It does not say "world-class" about
        anything. It does not list Dooley, the Emory Scholars Program, or
        Barkley Forum, because those are not load-bearing in this
        applicant's story. The essay picks two features and commits to
        them. That commitment is what 150 words demands. Trying to
        sprinkle more features in would have broken the structure without
        adding signal.
      </p>
      <p>
        Also notice the register. The prose is direct. Sentences are short
        when they need to be. There is one piece of self-assessment ("I
        think better in rooms of twelve than rooms of a hundred") that
        ...
        or Oxford" was put in the prompt to force.
      </p>

      <h2>Common Mistakes</h2>
      <ul>
        <li>
          <strong>Treating Atlanta and Oxford as one unit.</strong> The
          prompt's disjunction is deliberate. Writing "I love that Emory
          has two campuses" without engaging with the structural
          difference between them signals that you read the phrase but
          did not think about it. Pick the campus you applied to and let
          that choice shape the essay.
        </li>
        <li>
        ...
        <li>
          <strong>Namedropping programs without explaining fit.</strong>{" "}
          Listing "QTM, Goizueta, and the Emory Center for Ethics" in a
          single sentence is not engagement. It is a keyword stack. One
          named program that you connect to a real interest or question
          is worth more than four named programs in a row.
        </li>
        <li>
          <strong>Using "Atlanta" as a synonym for "diverse
        ...
        <li>
          ...
          hook.</strong> Emory's pre-health pool is deep. "I want to be a
          doctor and Emory is strong in pre-health" is true of roughly
          every pre-health applicant Emory reads. What separates strong
          pre-health Why essays is a specific detail: a specific research
          area you would want Rollins proximity for, a specific shadowing
          story that points to a specific clinical-to-research interest,
          a specific question about health policy that sends you to the
          Center for Ethics as well as to a pre-med classroom. Name a
          thing.
        </li>
        <li>
          <strong>Copy-paste Why-essay syndrome.</strong> If the essay
          you submitted to Emory could be converted to a Vanderbilt or
          Duke Why essay by changing the school's name and swapping two
          programs, your essay is not an Emory essay. It is a universal
          Why essay wearing an Emory sticker. The fix is structural:
          anchor in at least one feature that only Emory has, and make
          sure your reason for choosing it is Emory-specific.
        </li>
        <li>
          <strong>Spending the whole essay on background.</strong> You do
          not have 150 words to explain how you got interested in
          neuroscience. You have 150 words to say what about Emory's
          community you want and why. The Why essay is forward-looking
          by design. Your backstory lives in the personal-reflection
          supplement and the personal statement.
        </li>
        <li>
          <strong>Ending with "I cannot wait to be part of the Emory
          community."</strong> This closing sentence appears in a large
          fraction of Why essays across the applicant pool. It adds no
          information and no specificity. The final sentence is your
          last piece of real estate. Spend it on the personal signal
          from move three, not on a hallmark phrase.
        </li>
      </ul>

      <h2>How This Essay Coordinates With the Other Emory Supplement</h2>
      <p>
      ...
      <p>
        ...
        used two essays to do one essay's work.
      </p>
      <p>
        The clean division is simple. In the Why Emory essay, say what
        you would do here and why Emory specifically makes that possible.
      ...
      <p>
        One more coordination note. If you applied to Oxford, make sure
        the Oxford-ness appears in at least one of the two essays
        explicitly. It does not have to be the Why essay, though the Why
        essay is the natural place. What cannot happen is an application
        in which "Oxford" appears nowhere except on the form. Readers at
        Oxford are looking for applicants who chose Oxford. Silence on
      ...
      <p>
        ...
        . And if you are also writing a Penn supplement that has to
        engage with a school's intellectual origin story at an even
        ...
        walks through the same structural discipline.
      </p>
    </>
  );
}
