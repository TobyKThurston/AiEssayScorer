...
export default function Content() {
  return (
    <>
      <h2>Why the Columbia "Why Columbia" Essay Is Different From Every Other Supplemental</h2>
      <p>
      ...
      <h2>What the Core Curriculum Actually Is (Most Applicants Get This Wrong)</h2>
      <p>
      ...
      <ul>
        <li><strong>Literature Humanities (Lit Hum):</strong> Two semesters reading roughly 22 foundational texts of Western literature, from Homer's <em>Iliad</em> to Toni Morrison's <em>Song of Solomon</em>. Seminars of 22 students, twice a week, discussion-based.</li>
        <li><strong>Contemporary Civilization (CC):</strong> Two semesters of moral and political philosophy, from Plato's <em>Republic</em> through Marx, Nietzsche, Du Bois, and Simone de Beauvoir. Same seminar format.</li>
        <li><strong>Art Humanities and Music Humanities:</strong> One semester each, covering foundational works in visual art and classical and contemporary music.</li>
        <li><strong>Frontiers of Science:</strong> One semester connecting current scientific research to broader questions about evidence, inference, and the nature of scientific knowledge.</li>
        <li><strong>University Writing:</strong> One semester of rigorous academic writing instruction tied to Core texts.</li>
        <li><strong>Global Core and Science requirements:</strong> Courses engaging non-Western traditions and scientific reasoning.</li>
      </ul>
      <p>
      ...
      <h2>The Question the Core Is Actually Asking You</h2>
      <p>
      ...
      <h2>How to Structure the Columbia Why Essay</h2>
      <p>
      ...
      <ol>
        <li><strong>Open with a genuine intellectual tension or question</strong> (2–3 sentences). Not a universal truth. Not a quotation. A specific question you've been sitting with, ideally one that connects to your intended major or a theme in your application.</li>
        <li><strong>Identify what kind of education would help you engage that tension</strong> (2–3 sentences). This is where you name the Core specifically, but not generically. Name a specific text or element of the Core sequence and explain why that particular collision of ideas is the one you want.</li>
        <li><strong>Connect to your intended major or academic interests</strong> (2–3 sentences). Columbia wants to know what you'll study. Even if you're undecided, name a direction. Show how the Core's foundational work connects to where you want to go intellectually.</li>
        <li><strong>Name one or two specific Columbia resources beyond the Core</strong> (2–3 sentences). A faculty member's research, a specific lab, a Columbia-specific program like the Scholars of Excellence Program, the Center for Undergraduate Research and Fellowships, or a particular academic department's structure.</li>
      </ol>
      <p>
        The mistake most applicants make at step 4 is going too broad. "Columbia's research opportunities" is meaningless. "Professor Rebecca Goldstein's work on the intersection of philosophy of mind and fiction, which I've been following since reading <em>36 Arguments for the Existence of God</em>, and the fact that she has taught at Columbia" is specific enough to signal genuine preparation.
      </p>

      <h2>What to Avoid in the Columbia Why Essay</h2>
      <ul>
        <li><strong>Treating New York City as the main selling point.</strong> Thousands of students write about wanting to be in New York. It reads as filler unless you connect it specifically to an academic or research opportunity only Columbia's location makes possible.</li>
        <li><strong>Describing the Core as "well-rounded education."</strong> This phrase signals that you've looked at the website but haven't thought carefully about what the Core actually demands.</li>
        <li><strong>Listing Core texts without connecting them to your specific intellectual interests.</strong> Mentioning that you're excited to read Plato is not enough. Explain why you want to read Plato in a seminar room, in dialogue with other Columbia students, after having read Homer the year before.</li>
        <li><strong>Copying the structure of your Common App essay.</strong> The Why Columbia essay should add new information about who you are academically. If your Common App personal statement is about intellectual curiosity, the Columbia supplement should show that curiosity applied to a specific question in your intended field.</li>
        <li><strong>Mentioning Columbia's ranking or prestige.</strong> Admissions officers already know Columbia is prestigious. They want to know why you specifically belong there.</li>
      </ul>

      <h2>The Single Most Effective Line in a Columbia Supplemental</h2>
      <p>
      ...
      <h2>The Connection Between Why Columbia and Your Other Supplementals</h2>
      <p>
      ...
      <p>
        Before writing your Columbia supplementals, use our <Link href="/editor" className="text-oxblood hover:underline">AI essay review tool</Link> to score your Common App personal statement first. Knowing where your main essay is strongest will tell you what territory the Columbia supplements still need to cover. You can also read our <Link href="/blog/why-this-college-essay" className="text-oxblood hover:underline">Why This College guide</Link> for the underlying framework, and our <Link href="/blog/ivy-league-essay-tips" className="text-oxblood hover:underline">Ivy League essay tips</Link> for the signals Columbia is specifically looking for across your entire application.
      </p>
    </>
  );
}
