...
export function EditorNavigation({
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 h-14 bg-white border-b border-slate-200 flex items-center gap-3 px-4">
        {/* Logo + back */}
        <Link href="/editor" className="flex items-center gap-2 flex-shrink-0 mr-1">
        ...
        <Link
          href="/editor"
          className="flex items-center gap-1.5 text-xs text-[#64748B] hover:text-[#0F172A] transition-colors flex-shrink-0"
        >
