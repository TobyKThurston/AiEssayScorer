      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
              ...
              <span className="inline-block relative h-[1.15em] align-bottom" style={{ minWidth: "280px" }}>
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    className="absolute left-0 top-0 bg-gradient-to-r from-oxblood to-forest bg-clip-text text-transparent will-change-transform"
                  >
            ...
            {/* Social proof */}
            <div>
              <small className="text-pencil block mb-4">Students admitted to</small>
              <div className="flex flex-wrap gap-4 md:gap-6 items-center mb-3">
                {selectedUniversities.map((uni) => (
                  <div key={uni} className="text-pencil text-sm font-medium">
                    {uni}
                  </div>
                ))}
              </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="p-6 md:p-8 rounded-2xl bg-white border border-hair shadow-[0_16px_48px_rgba(148,163,184,0.2)]">
              {/* Score header */}
              <div className="flex items-center justify-between mb-6">
                <div>
                  <small className="text-pencil block mb-1">Essay quality score</small>
              ...
              {/* Progress bar */}
              <div className="relative h-2 bg-paper-2 rounded-full mb-6 md:mb-8 overflow-hidden">
                <motion.div
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <div className="px-3 py-1.5 rounded-full bg-paper-2 border border-[#3B82F6]/30 text-oxblood">
                  <small>Structure</small>
                </div>
                <div className="px-3 py-1.5 rounded-full bg-paper-2 border border-[#0EA5E9]/30 text-[#0EA5E9]">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <small className="text-ink-2">Strong narrative arc with clear progression</small>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#0EA5E9] mt-0.5 flex-shrink-0" />
                  <small className="text-ink-2">Concrete evidence supports key claims</small>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#0EA5E9] mt-0.5 flex-shrink-0" />
                  <small className="text-ink-2">Tone matches regional reading preferences</small>
                </div>
              </div>
            </div>
          </motion.div>
