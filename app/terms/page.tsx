  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      <main className="mx-auto max-w-3xl px-5 sm:px-6 py-10 sm:py-16">
        <h1 className="font-serif text-[28px] sm:text-[40px] md:text-[56px] leading-[1.05] tracking-[-0.02em] mb-2">Terms of Service</h1>
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[19px] sm:text-[22px] md:text-[24px] mb-3 text-ink">1. Acceptance of Terms</h2>
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[19px] sm:text-[22px] md:text-[24px] mb-3 text-ink">2. Use of the Service</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[19px] sm:text-[22px] md:text-[24px] mb-3 text-ink">3. Accounts and Access</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[19px] sm:text-[22px] md:text-[24px] mb-3 text-ink">4. Payments and Subscriptions</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[19px] sm:text-[22px] md:text-[24px] mb-3 text-ink">5. Intellectual Property</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[19px] sm:text-[22px] md:text-[24px] mb-3 text-ink">6. Disclaimer</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[19px] sm:text-[22px] md:text-[24px] mb-3 text-ink">7. Limitation of Liability</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[19px] sm:text-[22px] md:text-[24px] mb-3 text-ink">8. Changes to Terms</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[19px] sm:text-[22px] md:text-[24px] mb-3 text-ink">9. Contact</h2>
          <p className="text-ink-2 leading-relaxed">
