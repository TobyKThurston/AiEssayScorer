  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        <h1 className="font-serif text-[40px] md:text-[56px] leading-[1.05] tracking-[-0.02em] mb-2">Privacy Policy</h1>
        <p className="font-mono text-[11px] uppercase tracking-[0.16em] text-pencil mb-10">Last updated: April 2025</p>

        <section className="mb-8">
          <h2 className="font-serif text-[22px] md:text-[24px] mb-3 text-ink">1. Information We Collect</h2>
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[22px] md:text-[24px] mb-3 text-ink">2. How We Use Your Information</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[22px] md:text-[24px] mb-3 text-ink">3. Essay Content</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[22px] md:text-[24px] mb-3 text-ink">4. Data Sharing</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[22px] md:text-[24px] mb-3 text-ink">5. Cookies</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[22px] md:text-[24px] mb-3 text-ink">6. Data Retention</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[22px] md:text-[24px] mb-3 text-ink">7. Children&apos;s Privacy</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[22px] md:text-[24px] mb-3 text-ink">8. Your Rights</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[22px] md:text-[24px] mb-3 text-ink">9. Changes to This Policy</h2>
          <p className="text-ink-2 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-[22px] md:text-[24px] mb-3 text-ink">10. Contact</h2>
          <p className="text-ink-2 leading-relaxed">
